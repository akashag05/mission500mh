                    ...
                    <div className="col-lg-6">
                        <div className="section-heading">
                            ...
                            <p className="section__desc">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vel convallis erat, nec aliquet mauris. Sed vulputate id quam in accumsan. Nunc vitae euismod justo. Interdum et malesuada fames ac ante ipsum primis in faucibus. Nunc suscipit ipsum vel eros pellentesque fringilla.
                            </p>
                ...
                <div className="row contact-detail-action">
                    ...
                    <div className="col-lg-4">
                        <div className="contact-item contact-item3">
                            ...
                            <p className="contact__desc">
                                <i className="fa fa-envelope-o" aria-hidden="true"></i> contact@mission.com <br />
