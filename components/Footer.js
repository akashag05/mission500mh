                            ...
                            <div className="row footer-widget-wrap">
                                ...
                                <div className="col footer-item footer-item4">
                                    ...
                                    <ul className="contact__info">
                                        ...
                                        <li><Link href="mailto:info@mission500mh.com">info@mission500mh.com</Link></li>
                                        <li><Link href="tel:6668880000">+91-9876543210</Link></li>
                                    </ul>
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="copyright-desc">
                                        <p>© Copyright 2020 by <Link href="https://www.revdau.com">revdau.com</Link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
