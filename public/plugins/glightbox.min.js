!(function (t, e) {
    ...
    var x = {
        ...
        isObject: function (e) {
            return (
                "object" === t(e) && null != e && !x.isFunction(e) && !x.isArray(e)
            );
        },
        isNil: function (t) {
            return null == t;
    ...
    function w(t, e) {
        if (
            ((x.isNode(t) || t === window || t === document) && (t = [t]),
                x.isArrayLike(t) || x.isObject(t) || (t = [t]),
                0 != x.size(t))
        )
            ...
            (d.destroy = function () {
                w(u, function (e) {
                    ...
                    i.found && i.all.splice(i.evt, 1),
                        e.removeEventListener && e.removeEventListener(t, d, h);
                });
            }),
            w(u, function (e) {
                var i = S(e, t, d);
                ((e.addEventListener && o && !i.found) || !o) &&
                    (e.addEventListener(t, d, h), i.all.push({ eventName: t, fn: d }));
            }),
            d
        );
    }
    ...
    function N(t) {
        if (A(t.target, "plyr--html5")) {
            ...
            "enterfullscreen" == t.type && k(e, "fullscreen"),
                "exitfullscreen" == t.type && E(e, "fullscreen");
        }
    }
    var I = function () {
        var t =
        ...
        var u = "video" == i.type ? e.videosWidth : e.width,
            d = e.height;
        return (
            (i.width = x.has(i, "width") && "" !== i.width ? i.width : u),
            (i.height = x.has(i, "height") && "" !== i.height ? i.height : d),
            i
        );
    },
        D = function () {
            ...
            x.isFunction(this.settings.beforeSlideLoad) &&
                ...
                (x.isFunction(this.settings.afterSlideLoad) &&
                    ...
                    "" == i.title && "" == i.description
                        ...
                        : (r && "" !== i.title
                            ...
                            k(h.parentNode, "description-".concat(o))),
                    k(l, "gslide-".concat(s)),
                    k(e, "loaded"),
                    "video" === s)
            )
                return (
                    k(l.parentNode, "gvideo-container"),
                    l.insertBefore(L('<div class="gvideo-wrapper"></div>'), l.firstChild),
                    void X.apply(this, [e, i, d])
                );
            if ("external" === s) {
                var g = Y({
                    url: i.href,
                ...
                return (
                    (l.parentNode.style.maxWidth = "".concat(i.width, "px")),
                    void l.appendChild(g)
                );
            }
            if ("inline" !== s) {
                if ("image" === s) {
    ...
    function P(t, e, i) {
        ...
        if (!l) return !1;
        var r = l.cloneNode(!0);
        (r.style.height = x.isNumber(e.height)
            ? "".concat(e.height, "px")
            : e.height),
            (r.style.maxWidth = x.isNumber(e.width)
                ? "".concat(e.width, "px")
                : e.width),
                ...
                (this.loop(),
                    new h(I, {
                        touchStart: function (t) {
                            if (A(t.targetTouches[0].target, "ginner-container"))
                                return (r = !1), !1;
                            (r = !0),
                                (M = t.targetTouches[0]),
                                ...
                                (u = null),
                                A(c, "gslide-image") && (u = c.querySelector("img")),
                                E(D, "greset");
                        },
                        touchMove: function (s) {
                            if (r && ((M = s.targetTouches[0]), !v && !f)) {
                                ...
                                if (
                                    ...
                                    return H(c, "translate3d(".concat(w, "%, 0, 0)"));
                        ...
                        touchEnd: function () {
                            if (r) {
                                ...
                                if (!(e > 29 && u))
                                    return e < 29 && i < 25
                                        ? (k(D, "greset"), (D.style.opacity = 1), V(c))
                                        : void 0;
                                t.close();
                            }
                        },
                        ...
                        pinch: function (t) {
                            ...
                            if (((f = !0), e <= 1))
                                return (
                                    ...
                                    (m = null),
                                    (y = null),
                                    void u.setAttribute("style", "")
                                );
                            e > 4.5 && (e = 4.5),
                                (u.style.transform = "scale3d("
                                    .concat(e, ", ")
                                    .concat(e, ", 1)")),
                                (p = e);
                        },
            ...
            n(t, [
                    ...
                    value: function () {
                        var t =
                            arguments.length > 0 && void 0 !== arguments[0]
                                ...
                                : null;
                        if (
                            ((this.elements = this.getElements(t)), 0 == this.elements.length)
                        )
                            return !1;
                        ...
                        t && x.isNil(e) && (e = this.elements.indexOf(t)) < 0 && (e = 0),
                            x.isNil(e) && (e = 0),
                            this.build(),
                            C(
                                this.overlay,
                    ...
                    value: function () {
                        ...
                        (this.slideDescription = s.querySelector(".gslide-description")),
                            (this.slideDescriptionContained =
                                ...
                                A(this.slideDescription.parentNode, "gslide-media")),
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        ...
                        if (
                            (n.offsetWidth > 0 && s && (z(s), (s.style.display = "")),
                                E(t, this.effectsClasses),
                                e)
                        )
                            C(t, this.settings.openEffect, function () {
                                !u && i.settings.autoplayVideos && i.playSlideVideo(t),
                                    x.isFunction(i.settings.afterSlideChange) &&
                ...
                },
                {
                    ...
                    value: function (t) {
                        x.isNumber(t) &&
                            (t = this.slidesContainer.querySelectorAll(".gslide")[t]);
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (
                            ((this.elements = []),
                                !x.isNil(this.settings.elements) &&
                                x.isArray(this.settings.elements))
                        )
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        var e = x.has(this.settings.svg, "next")
                            ? this.settings.svg.next
                            : "",
                            i = x.has(this.settings.svg, "prev")
                                ? this.settings.svg.prev
                                : "",
                            n = x.has(this.settings.svg, "close")
                    ...
                    value: function () {
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    (s &&
                                        (A(s, "description-bottom") || A(s, "description-top")) &&
                                        !A(s, "gabsolute") &&
                                        (r = !0),
                                        n)
                                )
                                ...
                                if (i) {
                                    ...
                                    if (
                                        ...
                                        (i.parentNode.style.maxWidth = "".concat(g, "px")),
                                            r &&
                                            s.setAttribute("style", "max-width: ".concat(g, "px;"));
                                }
                            }
                        }
                    },
                ...
                },
                {
                    key: "loop",
                    value: function () {
                        var t = x.has(this.settings, "loopAtEnd")
                            ? this.settings.loopAtEnd
                            : null;
                        return (
                            (t = x.has(this.settings, "loop") ? this.settings.loop : t), t
                        );
                    },
                },
                {
                        ...
                        (this.closing = !0),
                            ...
                            C(this.activeSlide, this.settings.closeEffect, function () {
                                ...
                                E(g, "glightbox-open"),
                                    E(
                                        i,
                                        "glightbox-open touching gdesc-open glightbox-touch glightbox-mobile"
                                    ),
                                    (i.style.width = ""),
